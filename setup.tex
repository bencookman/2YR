...
% \usepackage{indentfirst}                % Do I want my first paragraphs to always be indented
...
% \linespread{1.2} % For papers
\linespread{1.5}
% \linespread{2.0} % For theses
...
\fancyfoot{}
\fancyfoot[LE,RO]{\raisebox{-0.15cm}\thepage}
\raggedbottom
...
\colorlet{bencitecol}{black}
\colorlet{benurlcol}{black}
\hypersetup{colorlinks=true, linkcolor=benlinkcol, citecolor=bencitecol, urlcolor=benurlcol}

% Note backref=true adds a page number (and hyperlink) to each reference so you can easily go back from the references to the main document. You may prefer backref=false if you need to stick strictly to a given reference style
\usepackage[style = ieee, backend = biber, backref = true, hyperref = auto]{biblatex}
\renewcommand*{\bibfont}{\scriptsize}
\DefineBibliographyStrings{english}{backrefpage = {Cited p\adddot},  backrefpages = {Cited pp\adddot}}
