...
% Choice of ABFs? Practically speaking Hermite and Legendre ABFs are useful as they are orthogonal polynomials, which improves the conditioning of M for higher values of k.
...
% values of $N_st$ are usually much larger than the numbers required for similar centrered finite difference. This is because we make no requirement of compactness is made, and we allow $N_st$ to be large to improve the accuracy and stability properties
...
% we require extra filtering on higher wavenumber inaccuracies
