...
\begin{equation}
\pdv{\vb{ω}}{t} + (\vb{u} \cdot \vnab ) \vb{ω} = (\vb{ω} \cdot \vnab ) \vb{u} + \frac{μ}{ρ} \tilde{Δ} \vb{ω}
\end{equation}
...
&& \uvec{n} \cdot (\uvec{n} \cdot \vnab ) & \vb{E} &&= 0
\quad \text{and} \\
