...
\emph{Acoustic impedance} represents the resistance of acoustics to travel through a given medium, measured in the frequency domain. At a computational boundary, this is represented by the ratio between acoustic pressure, $p_a$, and velocity $\vb{u}_a \cdot \uvec{n}$ in the Fourier domain:
\begin{equation}
