...
\subsection{High-Order Discretisation} \label{sec:high-order}
...
% FVM does...
% Easy to do non-uniform domains, but meshing can be a major problem


% FEM does...
% Weak form, DG method. Something about a polynomial basis
% Same problem with meshing
% Can do lagrangian
...
% ENO does ...
% Essentially non-oscillatory interpolants ... whatever that means
% for discontinuities, so is often used for combustion problems to to resolve flames and detonation shock waves.
