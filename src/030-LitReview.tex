...
\end{equation}
where $\hat{Z}$ is the acoustic impedance and hats $\hat{\cdot}$ represent Fourier transforms. Hence, impedance can be seen as the amount of acoustic motion resulting from a pressure disturbance of a fixed size for a given medium. This gives rise to the reflection coefficient $R$ \cite{douasbin2018DelayedtimeDomainImpedance}:
\begin{equation}
