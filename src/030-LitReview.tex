...
Substitutions performed in \cite{searby1986WeaklyTurbulentWrinkled} show that a downward propagating flame in two-dimensions under the influence of gravity (shown in \fig{fig:downward-flame}) may have its flame surface written as a damped harmonic oscillator:
...
% rayleigh1896TheorySound
% - introduces theoretical condition for a thermoacoustic instability, the Rayleigh criterion, where acoustic pressure and heat release fluctuations are amplified when they are in phase
