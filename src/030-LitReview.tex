...
% Copy some stuff from 1YR
% Split time and space as orthogonal problems to solve, with discretisations required for the temporal and spatial domains.
% Then we can choose whichever methods are the most suitable for our given problem to integrate in time and provide spatial discretisation for derivative approximations.

% Benefit of this approach is that the clear distinction of a spatial problem allows us to split this problem between different domains on different processors.

% DNS/LES chapters discuss the methods and logistics of performing such simulations
